...
public class TestS3InitURLs {
	...
	protected static final String TEST_URL_FILE_WITH_UMLAUTE = "https://ccopy.s3.amazonaws.com/test/Mit ‹mlaut+Sonderzeichen.txt";
	...
	protected static final String TMP_URL_WITH_UMLAUT = TMP_ROOT + "/file with+and√ú.txt";
	/**
	 * generic logger
	 */
